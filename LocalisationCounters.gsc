...
timer_hud()
{
	...
	timer_hud.vertalign = "user_bottom";
	timer_hud.x -= x;
	timer_hud.y += y;
	timer_hud.fontscale = 1.4;
	timer_hud.alpha = 0;
	timer_hud.glowAlpha = 0.60;
	timer_hud.glowcolor = (0, .494, .906);
	timer_hud.color = ( 1, 1, 1 );
	timer_hud.hidewheninmenu = 1;
	timer_hud.foreground = 1;
	timer_hud.label = &"Total time: ";
...
zone_hud()
{
	...
	zone_hud.alpha = 0;
	zone_hud.glowAlpha = 0.60;
	zone_hud.glowcolor = (0, .494, .906);
